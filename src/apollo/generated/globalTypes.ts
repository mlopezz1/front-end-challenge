...
export type AudioFieldPolicy = {
  autoPlay?: FieldPolicy<any> | FieldReadFunction<any>;
  id?: FieldPolicy<any> | FieldReadFunction<any>;
  url?: FieldPolicy<any> | FieldReadFunction<any>;
};
export type AuthorKeySpecifier = (
  | 'description'
  | 'id'
  | 'name'
  | AuthorKeySpecifier
...
export type PageMetaKeySpecifier = (
  | 'page'
  | 'pages'
  | 'total'
  | PageMetaKeySpecifier
)[];
export type PageMetaFieldPolicy = {
  page?: FieldPolicy<any> | FieldReadFunction<any>;
  pages?: FieldPolicy<any> | FieldReadFunction<any>;
  total?: FieldPolicy<any> | FieldReadFunction<any>;
};
export type QueryKeySpecifier = ('song' | 'songs' | QueryKeySpecifier)[];
export type QueryFieldPolicy = {
  song?: FieldPolicy<any> | FieldReadFunction<any>;
  songs?: FieldPolicy<any> | FieldReadFunction<any>;
};
export type SongKeySpecifier = (
  | 'audio'
  | 'author'
  | 'description'
  | 'genre'
...
export type SongResponseKeySpecifier = (
  | 'pageMeta'
  | 'songs'
  | SongResponseKeySpecifier
)[];
export type SongResponseFieldPolicy = {
  pageMeta?: FieldPolicy<any> | FieldReadFunction<any>;
  songs?: FieldPolicy<any> | FieldReadFunction<any>;
};
export type StrictTypedTypePolicies = {
  ...
  Author?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
    keyFields?:
      | false
      | AuthorKeySpecifier
      | (() => undefined | AuthorKeySpecifier);
    fields?: AuthorFieldPolicy;
  };
  PageMeta?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
    keyFields?:
      | false
      | PageMetaKeySpecifier
      | (() => undefined | PageMetaKeySpecifier);
    fields?: PageMetaFieldPolicy;
  };
  ...
  SongResponse?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
    keyFields?:
      | false
      | SongResponseKeySpecifier
      | (() => undefined | SongResponseKeySpecifier);
    fields?: SongResponseFieldPolicy;
  };
};
